...
class TrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracker" do
    assert_difference('Tracker.count') do
      post trackers_url, params: { tracker: { name: @tracker.name, threshold: @tracker.threshold, url: @tracker.url } }
    end
  ...
  test "should update tracker" do
    patch tracker_url(@tracker), params: { tracker: { name: @tracker.name, threshold: @tracker.threshold, url: @tracker.url } }
